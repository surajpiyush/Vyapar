          ...
          <table style={{ border: "1px solid black" }}>
            ...
            <tbody>
              {currPrintItem?.sale?.map((saleItem, index) => {
                const mainName =
                  saleItem?.mainName || FindItemMainName(saleItem?.itemName);
                ...
                const taxPercent = saleItem.taxPersant
                  ...
                  : 0;
                const taxAmount = priceUnit * (taxPercent / 100) * qty || 0;
                const priceWithTax =
                  Number(priceUnit) +
        ...
        <div className={css.FooterOuter}>
          <div className={css.FooterLeftSideDivOuter}>
            ...
            <div>
              ...
              <h3>{ConvertPriceToWords(currPrintItem?.total) || "Zero"}</h3>
            </div>
            {currPrintItem?.dueDate && (
              <h3>
                Due Date:{" "}
            ...
            <div className={css.invoiceStatsFooterOuter}>
              ...
              <div>
                ...
                <h2>
                  {currPrintItem?.sale
                    ?.reduce((total, item) => {
                      let discountPercentage = +item?.discountpersant || 0;
                      return (
                        total +
