...
const SidebarItems = [
  ...
  },
  {
    ...
    to: "/parties",
    childLinks: [
      { name: "Generate Barcode", to: "/parties" },
      { name: "Import Items", to: "/parties" },
      { name: "Bulk Update Items", to: "/parties" },
      { name: "Import From Tally", to: "/parties" },
      { name: "Import Parties", to: "/parties" },
      { name: "Import To Tally", to: "/parties" },
      { name: "Export To Tally", to: "/parties" },
      { name: "Export Items", to: "/parties" },
      { name: "Verify My Data", to: "/parties" },
      { name: "Recycle Bin", to: "/parties" },
      { name: "Close Financial Year", to: "/parties" },
    ],
  },
];
