...
const Pourchaseorder = ({ func }) => {
  ...
  const toggleAddPaymentOrderSuccess = useSelector(
    (store) => store.PurchaseReducer.toggleAddPaymentOrderSuccess
  );
  ...
  const handleDelete = (id) => {
    DeletePurchaseOrder(dispatch, id, toast);
  };
                    ...
                    <React.Fragment key={e._id}>
                      {isEditing && editedData?._id === e._id ? (
                        ...
                        <tr className="table-row" key={e._id}>
                          ...
                          <td className="table-h"> {e.orderNumber || "-"}</td>
                          ...
                          <td className="table-h"> ₹{e.total || 0}</td>
                          <td className="table-h"> ₹{e.balance || 0}</td>
