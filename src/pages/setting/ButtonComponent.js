        ...
        <section id="menu">
          ...
          <div class="items">
            <li>
              ...
              <Link to="/GeneralComponent">GENERAL</Link>
            </li>
            <li>
              <i className="fa-solid fa-gauge"></i>
              <Link to="/Setting">TRANSACTION</Link>
            </li>
            {/* i did not created transaction component */}
            <li>
              <i className="fa-solid fa-gauge"></i>
              <Link to="/GeneralComponent">PRINT</Link>
            </li>
            {/*i did not created print component create first compont*/}
            <li>
              <i className="fa-solid fa-gauge"></i>
              <Link to="/TAXESGSTComponent">TAXES & GST</Link>
            </li>
            <li>
              <i className="fa-solid fa-gauge"></i>
              <Link to="/GeneralComponent">TRANSACTION MESSAGE</Link>
            </li>
            <li>
              <i className="fa-solid fa-gauge"></i>
              <Link to="/GeneralComponent">PARTY</Link>
            </li>
            <li>
              <i className="fa-solid fa-gauge"></i>
              <Link to="/GeneralComponent">ITEM</Link>
            </li>
                        ...
                        <div className="dropdown">
                          ...
                          <div className="dropdown">
                            ...
                            <div className="dropdown-content">
                              ...
                              <a
                                href="#"
                                onClick={() => selectPaymentType("Cheque")}
                              >
                                Cheque
                              </a>
                            </div>
