...
const ItemsTableBody = memo(
  ({
    ...
    const [pricePerUnit, setPricePerUnit] = useState(item.priceUnit);
    const [percentDiscount, setPercentDiscount] = useState(
      item.discountpersant
    );
    const [amountDiscount, setAmountDiscount] = useState(item.discountAmount);
    const [percentTax, setPercentTax] = useState(item.taxPersant);
    const [amountTax, setAmountTax] = useState(item.taxAmount);
    const [finalAmount, setFinalAmount] = useState(item.amount);
