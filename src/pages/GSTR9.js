          ...
          <table className="table table-striped table-bordered">
                <thead>
                    <tr className="table-dark">
                        ...
                        <th scope="col" colSpan="2">Basic Details</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
        ...
        <div style={{ margin: "20px 20px" }}>
          <table className="table table-striped table-bordered text-center">
                <thead>
                    <tr className="table-dark">
                        <th scope="col">Pt. I</th>
                        <th scope="col" colSpan="6">Details Of Outward And Inward Supplies Declared During The Financial Year</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td scope="row">4</td>
                        <td colSpan="6">Details of advances, inward and outward supplies on which tax is payable as declared in returns filed during the financial year</td>
                    </tr>
                    <tr>
                        <td scope="row">A</td>
                    ...
                    <tr>
                        <td scope="row">F</td>
                        <td>Advances on which tax has been paid but invoice has not been issued (not cover under (A) to (E) above)</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
        ...
        <div style={{ margin: "20px 20px" }}>
          <table className="table table-striped table-bordered text-center">
                <thead>
                    <tr className="table-dark">
                        <th scope="col">5</th>
                        <th scope="col" colSpan="6">Details of Outward supplies on which tax is not payable as declared in returns filed during the financial year</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
          ...
          <table className="table table-striped table-bordered">
                <thead>
                    <tr className="table-dark">
                        ...
                        <th scope="col" colSpan="6">Details Of ITC As Declared In Returns Filed During The Financial Year</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td scope="row">6</td>
                        <td colSpan="6">Details of ITC availed as declared in returns filed during the financial year</td>
                    </tr>
                    <tr>
                        <td scope="row">A</td>
                        <td colSpan="2">Total amount of input tax credit availed through FORM GSTR-3B (sum total of Table 4A of FORM GSTR-3B)</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        <td scope="row">B</td>
                        <td>Inward supplies (other than imports and inward supplies liable to reverse charge but includes service received from SEZs)</td>
                        <td colSpan="6">
                           <table className="table table-striped table-bordered text-center">
                                <tbody>
                                    <tr>
                    ...
                    <tr>
                        <td scope="row">C</td>
                        <td>Inward supplies received from unregistered persons liable to reverse charge (other than B above) on which tax is paid & ITC availed</td>
                        <td colSpan="6">
                           <table className="table table-striped table-bordered text-center">
                                <tbody>
                                    <tr>
                    ...
                    <tr>
                        <td scope="row">D</td>
                        <td>Inward supplies received from registered persons liable to reverse charge (other than B above) on which tax is paid and ITC availed</td>
                        <td colSpan="6">
                           <table className="table table-striped table-bordered text-center">
                                <tbody>
                                    <tr>
                    ...
                    <tr>
                        <td scope="row">F</td>
                        <td colSpan="2">Import of services (excluding inward supplies from SEZs)</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        <td scope="row">H</td>
                        <td colSpan="2">Amount of ITC reclaimed (other than B above) under the provisons of Act</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        <td scope="row">K</td>
                        <td colSpan="2">Transition credit through TRAN-I (including revisions if any)</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
        ...
        <div style={{ margin: "20px 20px" }}>
          <table className="table table-striped table-bordered">
                <thead>
                    <tr className="table-dark">
                        <th scope="col">7</th>
                        <th scope="col" colSpan="6">Details of ITC Reversed and Ineligible ITC as declared in rerurns filed during the financial year</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
        ...
        <div style={{ margin: "20px 20px" }}>
          <table className="table table-striped table-bordered">
                <thead>
                    <tr className="table-dark">
                        <th scope="col">8</th>
                        <th scope="col" colSpan="6" className="text-center">Other ITC related information</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td scope="row">C</td>
                        <td>ITC on inward supplies (other than imports and inward supplies liable to reverse charge but includes services received from SEZs) received during 2017-18 but availed during April to September, 2018</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
          ...
          <table className="table table-striped table-bordered">
                <thead>
                    <tr className="table-dark">
                        ...
                        <th scope="col" colSpan="7" className="text-center">Other ITC related information</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
          ...
          <table className="table table-striped table-bordered">
                <thead>
                    <tr className="table-dark">
                        ...
                        <th scope="col" colSpan="6" className="text-center">Particulars Of The Transactions For The Previous FY Declared In Returns Of April To September Of Current FY Or Upto Date Of Filing Of Annual Return Of Previous FY Whichever Is Earlier</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td scope="row">11</td>
                        <td>Supplies/tax reduced through Amendments (+) (net of credit notes)</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
        ...
        <div style={{ margin: "20px 20px" }}>
          <table className="table table-striped table-bordered">
                <thead>
                    <tr className="table-dark">
                        <th scope="col">14</th>
                        <th scope="col" colSpan="3" className="text-center">Differential Tax Paid On Account Of Declaration In 10 & 11 Above</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
          ...
          <table className="table table-striped table-bordered">
                <thead>
                    <tr className="table-dark">
                        ...
                        <th scope="col" colSpan="8" className="text-center">Other Information</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td scope="row">15</td>
                        <td colSpan="8" className="text-center">Particulars of Demands and Refunds</td>
                    </tr>
                    <tr>
                        <td scope="row"></td>
                        <td>Details</td>
        ...
        <div style={{ margin: "20px 20px" }}>
          <table className="table table-striped table-bordered">
                <thead>
                    <tr className="table-dark">
                        <th scope="col">16</th>
                        <th scope="col" colSpan="6" className="text-center">Information On Supplies Received From Composition Taxpayers, Deemed Supply Under Section 143 And Goods Sent On Approval Basis</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
        ...
        <div style={{ margin: "20px 20px" }}>
          <table className="table table-striped table-bordered">
                <thead>
                    <tr className="table-dark">
                        <th scope="col">17</th>
                        <th scope="col" colSpan="8" className="text-center">HSN Wise Summary Of Outward Supplies</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td scope="row">HSN Code</td>
                        <td>UQC</td>
        ...
        <div style={{ margin: "20px 20px" }}>
          <table className="table table-striped table-bordered">
                <thead>
                    <tr className="table-dark">
                        <th scope="col">18</th>
                        <th scope="col" colSpan="8" className="text-center">HSN Wise Summary Of Inward Supplies</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
        ...
        <div style={{ margin: "20px 20px" }}>
          <table className="table table-striped table-bordered">
                <thead>
                    <tr className="table-dark">
                        <th scope="col">19</th>
                        <th scope="col" colSpan="3" className="text-center">Late Fee Payable And Paid</th>
                    </tr>
                </thead>
                <tbody>
