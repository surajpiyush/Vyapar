import css from "./ItemSerialReport.module.css";
...
marginLeft:"5px"
						...
						<input type="checkbox" name="" id="" style={{marginLeft:"5px", width:"20px"}}/>
						<small>Show only serial numbers in stock</small>
						</div>
...
export default ItemSerialReport;
