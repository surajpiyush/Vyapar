		...
		<div className={css.Outer}>
			...
			<div className={css.ContentOuter}>
				<div className={css.contentUpperNav}>
                    ...
                    <div style={{display:'flex',flexDirection:"column",width:"100%",justifyContent:"space-between",}}> <div> <p>DETAILS</p></div>
					
					<div style={{display:'flex',width:"100%",justifyContent:"space-between",}}><small>Filter by Item Category</small>  <select
						defaultValue="All"
						onChange={handleSelect}
						style={{
							backgroundColor: "#BFBFBF",
							 padding: "3px 3px",
							borderRadius: "2px",width:"200px",justifyContent:"center"
						}}
					>
