import css from "./LowStockSummery.module.css";
...
const LowStockSummery = () => {
	...
	const handleSearch = (e) => {
		...
		if (query === "") {
			...
			const filteredInvoice = data.filter((item) => regex.test(item.partyName));
		...
		<div className={css.Outer}>
			...
			<div className={css.topNavOuter}>
				<div className={css.navTopADiv}>
					...
					<div >	<input type="checkbox" name="" id="" style={{ width: '20px', height: '20px',border:"px solid #dae0db" }}  />  <small style={{paddingBottom:"15px",paddingLeft:"5px",marginBottom:"10px"}}>Show items in stock</small> </div>
...
export default LowStockSummery;
