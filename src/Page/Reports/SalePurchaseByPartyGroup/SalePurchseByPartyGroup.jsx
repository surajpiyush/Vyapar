...
import './SalePurchaseByPartyGroup.module.css'
...
<div className='topNavOuter'>
            ...
            <div className='contentUpperNav'>
					<div className='leftSideDivSaleOuter' style={{display:'flex',justifyContent:"space-between",padding:'2px 2px'}}>
                    <div>SALE PURCHASE BY PARTY GROUP</div>
