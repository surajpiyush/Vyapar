import css from "./SaleAndPurchaseReportByCategory.module.css";
...
const SaleAndPurchaseReportByCategory = () => {
	...
	return loadingSaleHSN ? (
		...
		<div className={css.Outer}>
			...
			<div className={css.topNavOuter}>
                ...
                <div>Party Name</div>
					<div style={{display:"flex",flexDirection:'column'}}> <input type="text"     placeholder="Party name" p    name="" id="" style={{border:"2px solid black",borderRadius:"5px",backgroundColor:"#dae0db"}} /></div>
			...
			<div className={css.ContentOuter}>
				<div className={css.contentUpperNav}>
					<p className={css.leftSideDivSaleOuter}>
...
export default SaleAndPurchaseReportByCategory;
