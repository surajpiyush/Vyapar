...
import { DeleteCompany, FetchAllCompanies, LOGOUT } from "../../Redux/business/action";
import {
   SET_CURRENT_COMPANY,
   USER_DETAILS,
               ...
               <div className="companyListContainer">
                  {isError ? (
                     ...
                     allCompaniesData?.map((item, ind) => (
                        <section
                           key={ind + item._id}
                           className="company-section-items"
                        >
                           ...
                           <aside className="company-section-items-right">
                              ...
                              <MdDelete className="company-section-items-right-dot" onClick={()=>handleDeleteCompany(item._id)} />
